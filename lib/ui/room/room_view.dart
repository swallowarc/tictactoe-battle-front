...
import 'package:tictactoe_battle_frontend/ui/room/room_controller.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';

final StateNotifierProvider<RoomController, RoomControllerState> _controllerProvider = StateNotifierProvider(
    (ref) => RoomController(ref.read(battleServiceProvider.notifier), ref.read(loginServiceProvider.notifier)));
